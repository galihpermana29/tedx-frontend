  ...
  return (
    <div className="relative p-3 rounded-xl w-full lg:w-[60%] bg-flower">
      <div className="bg-white overflow-y-scroll h-full rounded-md p-5">
        <div className="flex justify-between xs:flex-col text-start">
          <h1 className="creat font-[700] md:text-[24px] xs:text-[20px]">
            {data.name}
          </h1>
          <h1 className="creato font-[700] md:text-[24px] xs:text-[20px] text-orange-primary">
            {data.price}
          </h1>
        </div>
