...
function MainEventSpeakersMobile() {
  return (
    <Carousel hideButton className="cursor-grab active:cursor-grabbing">
      {/* speaker 1 */}
      <div className="text-orange-darker w-[87%] sm:w-[80%] md:w-[50%] flex flex-col shrink-0 gap-5 mx-20">
      ...
      {/* speaker 2 */}
      <div className="text-orange-darker shrink-0 w-[87%] sm:w-[80%] md:w-[50%] flex flex-col gap-5 mr-20">
      ...
      {/* speaker 4 */}
      <div className="text-orange-darker shrink-0 w-[87%] sm:w-[80%] md:w-[50%] flex flex-col gap-5 mr-40">
        <div className="bg-yellow-primary w-full aspect-[3/4] p-5 relative">
...
export default MainEventSpeakersMobile;
